...
export const masterValues: MasterValue[] = [
  // ランニングコスト
  { id: "up-r1", category: "ランニングコスト", code: "running_electricity",   label: "水道光熱費",   unit: "円/月", defaultAmount: 150000, currentAmount: 150000, note: "50坪あたりの目安" },
  { id: "up-r2", category: "ランニングコスト", code: "running_water",         label: "水道代",       unit: "円/月", defaultAmount:  30000, currentAmount:  30000, note: "水道代込みの場合は0円に" },
  { id: "up-r3", category: "ランニングコスト", code: "running_staff",         label: "人件費",       unit: "円/月", defaultAmount: 500000, currentAmount: 500000, note: "常勤2名想定" },
  { id: "up-r4", category: "ランニングコスト", code: "running_cleaning",      label: "清掃費",       unit: "円/月", defaultAmount:  50000, currentAmount:  50000, note: "業者委託" },
  { id: "up-r5", category: "ランニングコスト", code: "running_communication", label: "通信費",       unit: "円/月", defaultAmount:  20000, currentAmount:  20000, note: "Wi-Fi・システム利用料" },
  { id: "up-r6", category: "ランニングコスト", code: "running_supplies",      label: "消耗品費",     unit: "円/月", defaultAmount:  30000, currentAmount:  30000, note: "タオル・洗剤等" },
  { id: "up-r7", category: "ランニングコスト", code: "running_insurance",     label: "保険料",       unit: "円/月", defaultAmount:  15000, currentAmount:  15000, note: "施設賠償責任保険等" },
  { id: "up-r8", category: "ランニングコスト", code: "running_advertising",   label: "広告宣伝費",   unit: "円/月", defaultAmount: 100000, currentAmount: 100000, note: "SNS・チラシ等" },
  { id: "up-r9", category: "ランニングコスト", code: "running_other",         label: "その他",       unit: "円/月", defaultAmount:  50000, currentAmount:  50000, note: "雑費など" },
  // 投資コスト
  { id: "up-i1",  category: "投資コスト", code: "investment_fitness_machine", label: "フィットネスマシン費",    unit: "円",   defaultAmount: 12000000, currentAmount: 12000000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 6000000, amountWithRoyalty: 12000000, note: "ロイヤリティなしは本部提示額の50%想定" },
  { id: "up-i2",  category: "投資コスト", code: "investment_interior",        label: "内装工事費",              unit: "円/坪", defaultAmount:  160000, currentAmount:  160000,  note: "坪単価目安" },
  { id: "up-i3",  category: "投資コスト", code: "investment_flapper_gate",    label: "フラッパーゲート",        unit: "円",   defaultAmount:   800000, currentAmount:   800000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 300000, amountWithRoyalty: 800000, note: "1台あたり" },
  { id: "up-i4",  category: "投資コスト", code: "investment_body_composition", label: "体組成計",                unit: "円/台", defaultAmount:   830000, currentAmount:   830000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 680000, amountWithRoyalty: 830000, note: "1台あたり" },
  { id: "up-i5",  category: "投資コスト", code: "investment_water_server",    label: "ウォーターサーバー",      unit: "円/台", defaultAmount:   350000, currentAmount:   350000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 250000, amountWithRoyalty: 350000, note: "1台あたり" },
  { id: "up-i6",  category: "投資コスト", code: "investment_franchise_fee",   label: "フランチャイズ加盟費用",  unit: "円",   defaultAmount:  2000000, currentAmount:  2000000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 0, amountWithRoyalty: 2000000, note: "本部規定に準じる" },
  { id: "up-i7",  category: "投資コスト", code: "investment_system",          label: "システム導入費",          unit: "円",   defaultAmount:   500000, currentAmount:   500000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 0, amountWithRoyalty: 500000, note: "会員管理・予約システム" },
  { id: "up-i8",  category: "投資コスト", code: "investment_opening_prep",    label: "開業準備費",              unit: "円",   defaultAmount:  1000000, currentAmount:  1000000, royaltyRuleEnabled: true, royaltyRuleMode: "rate", amountWithoutRoyalty: 500000, amountWithRoyalty10: 1000000, amountWithRoyalty15: 1500000, note: "ロイヤリティ率で変動" },
  { id: "up-i9",  category: "投資コスト", code: "investment_opening_package", label: "開業前パッケージ費",      unit: "円",   defaultAmount:  1100000, currentAmount:  1100000, royaltyRuleEnabled: true, royaltyRuleMode: "binary", amountWithoutRoyalty: 550000, amountWithRoyalty: 1100000, note: "50坪基準。坪数連動式は別途考慮" },
  { id: "up-i10", category: "投資コスト", code: "investment_security",        label: "ALSOK/USEN導入費",        unit: "円",   defaultAmount:   200000, currentAmount:   200000, note: "セキュリティ・BGM" },
  { id: "up-i11", category: "投資コスト", code: "investment_other",           label: "その他",                  unit: "円",   defaultAmount:   500000, currentAmount:   500000, note: "予備費" },
]
