...
export const masterValues: MasterValue[] = [
  ...
  // 投資コスト
  { id: "up-i1",  category: "投資コスト", code: "investment_fitness_machine", label: "フィットネスマシン費",    unit: "円",   defaultAmount: 12000000, currentAmount: 12000000, note: "台数×単価の目安" },
  ...
  { id: "up-i3",  category: "投資コスト", code: "investment_flapper_gate",    label: "フラッパーゲート",        unit: "円",   defaultAmount:  1500000, currentAmount:  1500000, note: "1台あたり" },
  { id: "up-i4",  category: "投資コスト", code: "investment_body_composition", label: "体組成計",                unit: "円/台", defaultAmount:  100000, currentAmount:  100000,  note: "1台あたり" },
  { id: "up-i5",  category: "投資コスト", code: "investment_water_server",    label: "ウォーターサーバー",      unit: "円/台", defaultAmount:   50000, currentAmount:   50000,  note: "1台あたり" },
  { id: "up-i6",  category: "投資コスト", code: "investment_franchise_fee",   label: "フランチャイズ加盟費用",  unit: "円",   defaultAmount:  4500000, currentAmount:  4500000, note: "本部規定に準じる" },
  { id: "up-i7",  category: "投資コスト", code: "investment_system",          label: "システム導入費",          unit: "円",   defaultAmount:   800000, currentAmount:   800000, note: "会員管理・予約システム" },
  { id: "up-i8",  category: "投資コスト", code: "investment_opening_prep",    label: "開業準備費",              unit: "円",   defaultAmount:   300000, currentAmount:   300000, note: "各種申請・備品等" },
  { id: "up-i9",  category: "投資コスト", code: "investment_opening_package", label: "開業前パッケージ費",      unit: "円",   defaultAmount:   600000, currentAmount:   600000, note: "研修・サポート費用含む" },
